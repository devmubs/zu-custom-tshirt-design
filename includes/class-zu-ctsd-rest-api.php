...
class ZU_CTSD_REST_API {
    ...
    public function calculate_price(WP_REST_Request $request): WP_REST_Response {
        // Implement rate limiting - 30 requests per minute
        if (!ZU_CTSD_Security::check_rate_limit('calculate_price', 30, 60)) {
            ZU_CTSD_Security::log_security_event('rate_limit_exceeded', ['action' => 'calculate_price']);
            return new WP_REST_Response([
                'success' => false,
        ...
        // Validate design_data is an array
